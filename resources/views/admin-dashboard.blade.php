...
@section('title')
  <title>OSU | Admin Dashboard</title>
@endsection
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-4 py-3">
                ...
                <div class="info">
                  <div class="title">
                    ...
                    <div class="form-navigation btn-group w-100 my-1">
                      ...
                      <button class="mi btn btn-sm btn-outline-danger w-50 " data-target="#delete_{{$data->doc_id}}" data-toggle="modal" type="button">TRASH</button>
                    </div>
                    ...
                    <div id="buttonhide">
                      <div class="form-navigation btn-group w-100 my-1">
                        ...
                        <form class="mb-0" data-parsley-validate="" method="post" action="{{ route('printPDF') }}">
                          {{ csrf_field() }}
                          <button class="mi btn btn-danger w-100" id="submit" type="submit" name="print" value="{{ $data->doc_id }}"  onClick="loadPDF(this.value)" 
          ...
          <!-- START of MODAL for deleting documents -->
                                    <form class="mb-0" data-parsley-validate="" method="post" action="{{ route('trashDocu') }}">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header" style="background-color: #860c23; color: white; display: block;">
                                              <h2 class="cust-h2 mb-0">Move to Trash</h2>
                                            </div>
                                            <div class="modal-body p-1">
                                              <center>
                                                <br>
                                                <h1 style="font-family: 'Segoe UI Light'; font-weight: bold;">WARNING!</h1>
                                                <br>
                                                  <h3 style="font-family: 'Segoe UI Light'; font-weight: lighter;">This document has already been signed by 
                                                    <span style="font-family: 'Segoe UI Light'; font-weight: bold;">{{$data->totalprogress}}%</span> 
                                                  of the signatories.</h3>
                                              </center>
                                              <center>
                                                <h3 style="font-family: 'Segoe UI Light'; font-weight: lighter;">Are you sure you want to move 
                                            ...
                                            <div class="modal-footer p-2">
                                              <button class="btn btn-danger w-50" id="submit" type="submit" name="docID" value="{{ $data->doc_id }}" onClick="loadThis(this.value)">MOVE TO TRASH</button>
                                  ...
                                  @if($ad->doc_id == $data->doc_id)
                                    <div class="item d-flex align-items-center py-2">
                                      ...
                                      <div class="text w-100">
                                        <p class="mb-0">{{ $ad->u_fname }}&nbsp;{{ $ad->u_lname }}</p><small><i>{{ $ad->designation }}, {{ $ad->office }}</i></small>
