                                        ...
                                        <tr>
                                            <td class="body_copy">
                                                ...
                                                <div style="text-align: justify;">
                                                    ...
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: bolder; display: inline;">DISABLED</h3>
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: lighter; display: inline;"> from the system. The action taken is irrevocable, hence you won't be able to sign in with your USeP OSU account from this day forward.
                                                    <br><br>
