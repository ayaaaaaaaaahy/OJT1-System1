                                        ...
                                        <tr>
                                            <td class="body_copy">
                                                ...
                                                <div style="text-align: justify;">
                                                    ...
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: bolder; display: inline;">REMOVED</h3>
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: lighter; display: inline;"> from the system. The document is moved to the system's Recycle Bin and is subject for deletion, hence you won't be able to see the said document for the meantime.
                                                    <br><br>
