                                        ...
                                        <tr>
                                            <td class="body_copy">
                                                ...
                                                <div style="text-align: justify;">
                                                    ...
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: bolder; display: inline;">RECOVERED</h3>
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: lighter; display: inline;"> from the system's Recycle Bin. By the administrator's decision, the specified document is restored, hence you will be able to access it once again upon signing in.
                                                    <br><br>
