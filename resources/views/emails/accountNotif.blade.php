                                        ...
                                        <tr>
                                            <td class="body_copy">
                                                ...
                                                <div style="text-align: justify;">
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: lighter; display: inline;">You are hereby notified that your <a href="http://localhost:8000">USeP OSU</a> signatory account is </h3>
                                                    @if ($stat == "ACCEPT")
                                                            <h3 style="font-family: 'Segoe UI Light'; font-weight: bolder; display: inline;">ACCEPTED</h3>
                                                    @else
                                                            <h3 style="font-family: 'Segoe UI Light'; font-weight: bolder; display: inline;">DECLINED</h3>
                                                    @endif
                                                    <h3 style="font-family: 'Segoe UI Light'; font-weight: lighter; display: inline;"> by the administrator. 
                                                        @if ($stat == "ACCEPT")
                                                            You can now log in and access documents with your new account.
                                                        @else
                                                            Hence, you cannot log in and access documents with your created account.
                                                        @endif
                                                    <br><br>
