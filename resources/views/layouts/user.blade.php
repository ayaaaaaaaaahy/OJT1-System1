    ...
    <div class="page-content d-flex align-items-stretch" style=" min-height: calc(100vh - 70px); max-height: fit-content;">
      ...
      <nav class="side-navbar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img alt="..." class="img-fluid rounded-circle" src="{{asset('auth/img/avatar-1.jpg')}}"></div>
        ...
        <ul class="list-unstyled">
          ...
          <li @yield('a2') >
            <a href="{{route('udocumenthistory')}}" aria-expanded="false"> <i class="icon-clock"></i>My History </a>
          </li>
        </ul>
      </nav>
      @yield('content')
